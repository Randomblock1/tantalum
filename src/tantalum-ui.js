(function (exports) {
    ...
    exports.ButtonGroup = function (targetId, vertical, labels, selectionCallback) {
        ...
        if (!target) /* Silently failing is always the best option! I am a good developer! */ return;
    ...
    exports.Slider.prototype.setValue = function (value) {
        ...
        if (value != this.value) {
            ...
            var percentage = Math.max(
                Math.min(Math.floor((100.0 * (value - this.minValue)) / (this.maxValue - this.minValue)), 100.0),
                0.0,
            );
